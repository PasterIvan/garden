        ...
        <div className={style.aboutUs}>
            ...
            <div className={style.aboutUsBody}>
                ...
                <div className={style.aboutUsBodyText}>
                    ...
                    <p>
                        Резиденция работает в 4 направлениях:
                    </p>
                    <p>
                        <b>— cпортивное.</b> Развитие и популяризация активного отдыха. Велопрогулки: разработаны 5 веломаршрутов,
                    ...
                    <p>
                        <b>— культурно-познавательное.</b> Создание города мастеров, возрождение народных промыслов и культурных традиций.
                    </p>
                    <p>
                        <b>Реализация проекта <b className={style.aboutUsBodyTextGreen}>«Старый сад на новый лад»</b></b>.
