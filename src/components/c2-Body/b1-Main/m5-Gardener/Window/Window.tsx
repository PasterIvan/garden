  ...
  const formik = useFormik({
    ...
    validate: (contacts) => {
      ...
      if (!contacts.email) {
        ...
        !/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i.test(contacts.email)
      ) {
  ...
  return (
    <div className={style.border}>
            ...
            <DialogContentText component="div" id="alert-dialog-description">
              <div>
                ...
                <p>
                  ...
                  <b>{form.contacts && form.contacts.email}</b>
                </p>
              </div>
            </DialogContentText>
          </DialogContent>
      ...
      <div className={style.additional}>
        <div style={{ width: "100%" }}>
          Саженцы/семена растений покупаются за счет средств
        </div>
        <div className={style.text2}>
          Президентский фонд культурных инициатив , вы оплачиваете латунную
          табличку, на которой будет написана информация о растении и Вас, как
          владельца посадки, а так же годовой уход за вашим растением, что
